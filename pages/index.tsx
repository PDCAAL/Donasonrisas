      ...
      <header className="border-b bg-white sticky top-0 z-50 shadow-sm">
        <div className="container-app flex items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
            <a href="/quienes-somos" className="hover:text-brand-red">
              Quiénes somos
            </a>
            <a href="/programas" className="hover:text-brand-red">
              Programas
            </a>
            <a href="/transparencia" className="hover:text-brand-red">
              Transparencia
            </a>
            <a href="/contacto" className="hover:text-brand-red">
              Contacto
            </a>
            <a
              href="/donar"
              className="btn-primary text-sm tracking-wide shadow-md"
            >
              Donar ahora
            </a>
          </nav>
        ...
        <div className="container-app grid gap-10 lg:grid-cols-2 items-center">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              <a href="/donar" className="btn-primary">
                Donar ahora
              </a>
              <a href="/apadrinar" className="btn-secondary">
                Apadrinar
              </a>
            </div>
          </div>
      ...
      <section className="section">
        <div className="container-app text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
            <div>
              <div className="text-4xl font-extrabold text-brand-red">+5,000</div>
              <div className="text-gray-600">Niños beneficiados</div>
            </div>
            <div>
              <div className="text-4xl font-extrabold text-brand-red">120</div>
              <div className="text-gray-600">Colegios aliados</div>
            </div>
            <div>
              <div className="text-4xl font-extrabold text-brand-red">24</div>
              <div className="text-gray-600">Regiones atendidas</div>
            </div>
            <div>
              <div className="text-4xl font-extrabold text-brand-red">100%</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card p-6">
              <p className="text-gray-700 italic">
                “Gracias a DonaSonrisas, mi hija pudo volver al colegio con todos sus útiles.”
              </p>
              <div className="mt-4 font-semibold text-brand-red">María, Madre beneficiaria</div>
            </div>
            <div className="card p-6">
              <p className="text-gray-700 italic">
                “La transparencia y cercanía de la ONG me motivaron a convertirme en padrino.”
              </p>
              <div className="mt-4 font-semibold text-brand-red">Carlos, Donante</div>
            </div>
            <div className="card p-6">
              <p className="text-gray-700 italic">
                “Ser voluntario me hizo ver cómo la unión puede cambiar vidas.”
              </p>
      ...
      <footer className="border-t bg-white">
        <div className="container-app py-6 flex flex-col sm:flex-row justify-between items-center text-gray-600 text-sm">
          ...
          <div className="flex gap-4 mt-3 sm:mt-0">
            <a href="https://wa.me/51997374878" className="hover:text-brand-red">
              WhatsApp
